...
@property(nonatomic,assign) CGFloat mass;//质量，影响图层运动时的弹簧惯性，质量越大，弹簧拉伸和压缩的幅度越大
@property(nonatomic,assign) CGFloat stiffness;//刚度系数(劲度系数/弹性系数)，刚度系数越大，形变产生的力就越大，运动越快
@property(nonatomic,assign) CGFloat damping;//阻尼系数，阻止弹簧伸缩的系数，阻尼系数越大，停止越快
@property(nonatomic,assign) CGFloat initialVelocity;//初始速率，动画视图的初始速度大小;速率为正数时，速度方向与运动方向一致，速率为负数时，速度方向与运动方向相反
/**
 transition转场动画
 */
