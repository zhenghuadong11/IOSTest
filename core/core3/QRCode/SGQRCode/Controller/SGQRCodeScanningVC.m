...
@property (nonatomic, strong) SGQRCodeScanManager * scanningMG;
...
- (void)removeScanningView {
    [self.scanningMG SG_stopRunning];
    [self.scanningMG SG_videoPreviewLayerRemoveFromSuperlayer];
    [self.scanningView removeTimer];
    [self.scanningView removeFromSuperview];
    
    
    [self.scanningMG SG_palySoundName:@"SGQRCode.bundle/sound.caf"];
...
- (void)QRCodeScanManager:(SGQRCodeScanManager *)scanManager didOutputMetadataObjects:(NSArray *)metadataObjects {
    ...
    if (metadataObjects != nil && metadataObjects.count > 0) {
        ...
        [self.navigationController popViewControllerAnimated:true];
        [self.delegate QRCodeScanManager:scanManager didOutputMetadataObjects:metadataObjects];
